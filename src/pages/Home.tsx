...
export const HomePage: React.FC<Props> = ({
  ...
  useEffect(() => {
    async function fetchPosts() {
      //setFilteredPosts(await popular());
      if (filter === "popular") {
        setFilteredPosts(await popular(selectedGenre));
      } else if (filter === "mostViewed") {
        setFilteredPosts(await mostview(selectedGenre));
  ...
  return (
    <div className="w-full px-4 py-8 bg-linear-to-br from-slate-50 via-gray-50 to-blue-50">
