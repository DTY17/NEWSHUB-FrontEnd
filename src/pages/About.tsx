  ...
  <div className="w-full px-4 py-12">
    <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg p-8">
      ...
      <div className="flex flex-col md:flex-row gap-8 items-start">
        <div className="w-48 h-48 bg-linear-to-br from-indigo-500 to-purple-500 rounded-full flex items-center justify-center text-white text-6xl font-bold shrink-0">JD</div>
