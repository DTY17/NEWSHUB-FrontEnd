...
//       className={
//         mode === "dark"
//           ? "dark bg-linear-to-br from-slate-900 via-gray-800 to-slate-700 text-white pb-20"
//           : "bg-linear-to-br from-slate-900 via-gray-900 to-slate-800 text-white pb-20"
//       }
//     >
//       <div className="w-full px-4 py-12">
//         <div className="max-w-[1600px] mx-auto">
...
//                   <button
//                     key={g}
//                     className="text-left text-gray-400 dark:text-gray-300 hover:text-blue-400 hover:translate-x-1 transition-all duration-200 text-sm"
//                   >
//                     {g}
//                   </button>
//                 ))}
...
//                 <a
//                   href="mailto:contact@newshub.com"
//                   className="flex items-center space-x-3 text-gray-400 dark:text-gray-300 hover:text-blue-400 transition-colors duration-200 group"
//                 >
//                   <div className="w-8 h-8 bg-blue-600 bg-opacity-20 dark:bg-opacity-10 rounded-lg flex items-center justify-center group-hover:bg-opacity-30 transition-all">
//                     <Mail size={16} className="text-blue-400" />
//                   </div>
//                   <span className="text-sm">contact@newshub.com</span>
//                 </a>
...
//                   <span className="text-sm">+1 (555) 123-4567</span>
//                 </a>
//                 <div className="flex items-center space-x-3 text-gray-400 dark:text-gray-300 group">
//                   <div className="w-8 h-8 bg-blue-600 bg-opacity-20 dark:bg-opacity-10 rounded-lg flex items-center justify-center">
//                     <MapPin size={16} className="text-blue-400" />
//                   </div>
//                   <span className="text-sm">123 News Street, NY 10001</span>
//                 </div>
...
//             <div className="md:col-span-1">
//               <h3 className="text-lg font-bold mb-4 text-blue-400 uppercase tracking-wide">Follow Us</h3>
//               <p className="text-gray-400 dark:text-gray-300 text-sm mb-4">Stay connected for the latest updates</p>
//               <div className="flex space-x-3">
//                 <button className="w-11 h-11 bg-linear-to-br from-blue-500 to-blue-600 rounded-lg flex items-center justify-center hover:scale-110 hover:shadow-lg hover:shadow-blue-500/50 transition-all duration-300">
...
//                 </button>
//                 <button className="w-11 h-11 bg-linear-to-br from-red-500 to-red-600 rounded-lg flex items-center justify-center hover:scale-110 hover:shadow-lg hover:shadow-red-500/50 transition-all duration-300">
//                   <Youtube size={20} className="text-white dark:text-white" />
//                 </button>
//               </div>
//             </div>
//           </div>
...
//           <div className="border-t border-gray-700 pt-8">
//             <div className="flex flex-col md:flex-row justify-between items-center gap-4">
//               <p className="text-gray-400 dark:text-gray-300 text-sm">&copy; 2025 NewsHub. All rights reserved.</p>
//               <div className="flex space-x-6 text-sm">
//                 <button className="text-gray-400 dark:text-gray-300 hover:text-blue-400 transition-colors duration-200">
//                   Privacy Policy
//                 </button>
//                 <button className="text-gray-400 dark:text-gray-300 hover:text-blue-400 transition-colors duration-200">
//                   Terms of Service
