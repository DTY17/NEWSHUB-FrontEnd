...
//         <div className="max-w-[1600px] mx-auto">
//           <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-8 mb-8 border-l-4 border-blue-600 dark:border-blue-500">
//             <div className="flex items-center gap-3 mb-6">
//               <div className="w-12 h-12 bg-linear-to-br from-blue-600 to-indigo-600 rounded-lg flex items-center justify-center">
//                 <Search size={24} className="text-white" />
//               </div>
//               <div>
//                 <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Search Posts</h1>
...
//                       }
//                     }}
//                     className="w-full pl-11 pr-4 py-3 border-2 border-gray-300 dark:border-gray-700 rounded-lg focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-100 dark:focus:ring-gray-700 text-gray-800 dark:bg-gray-900 dark:text-gray-100 placeholder-gray-400 transition-all duration-200"
//                   />
//                   <Search
//                     className="absolute left-3.5 top-3.5 text-gray-400 dark:text-gray-400"
//                     size={20}
//                   />
//                 </div>
//               </div>
...
//                       setCurrentSearchPage(1);
//                     }}
//                     className="w-full pl-11 pr-4 py-3 border-2 border-gray-300 dark:border-gray-700 rounded-lg focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-100 dark:focus:ring-gray-700 text-gray-800 dark:bg-gray-900 dark:text-gray-100 bg-white appearance-none cursor-pointer transition-all duration-200"
//                   >
//                     {genres.map((genre) => (
//                       <option key={genre} value={genre}>
//                         {genre}
...
//                   <Filter
//                     className="absolute left-3.5 top-3.5 text-gray-400 pointer-events-none dark:text-gray-400"
//                     size={20}
//                   />
//                   <ChevronRight
//                     className="absolute right-3 top-3.5 text-gray-400 pointer-events-none rotate-90 dark:text-gray-400"
//                     size={20}
//                   />
//                 </div>
//               </div>
...
//                   Found{" "}
//                   <span className="font-bold text-blue-600 text-lg">{filteredPosts.length}</span>{" "}
//                   {filteredPosts.length === 1 ? "post" : "posts"}
//                 </div>

//                 {searchPageGenre !== "All" && (
//                   <span className="px-4 py-1.5 bg-blue-100 text-blue-700 rounded-full font-medium text-sm dark:bg-blue-900/30 dark:text-blue-300">
//                     {searchPageGenre}
//                   </span>
//                 )}
//               </div>
...
//             </div>
//           ) : filteredPosts.length === 0 ? (
//             <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-16 text-center border border-gray-100 dark:border-gray-700">
//               <div className="w-24 h-24 bg-gray-100 dark:bg-gray-700 rounded-full flex items-center justify-center mx-auto mb-6">
//                 <Search size={48} className="text-gray-300 dark:text-gray-400" />
//               </div>

//               <h3 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-3">No posts found</h3>
...
//                     <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden hover:shadow-2xl transition-all duration-300 border border-gray-100 dark:border-gray-700 h-full flex flex-col">
//                       <div className="relative overflow-hidden">
//                         <img
//                           src={post.image?.[0] || ""}
//                           alt={post.topic}
...
//                         <p className="text-gray-600 dark:text-gray-300 mb-4 line-clamp-3 text-sm leading-relaxed flex-1">
//                           {Array.isArray(post.paragraph) ? post.paragraph.join(" ") : post.paragraph}
//                         </p>
...
//                               console.log("Click");
//                             }}
//                             className="text-gray-400 hover:text-blue-600 transition-colors duration-200 p-2 hover:bg-blue-50 rounded-lg dark:hover:bg-gray-700/40"
//                           >
//                             <Bookmark size={18} />
//                           </button>
//                         </div>
...
//               <div className="flex flex-col sm:flex-row justify-center items-center gap-4 mt-10 bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 border border-gray-100 dark:border-gray-700">
//                 <button
//                   disabled={currentSearchPage === 1}
//                   onClick={() => {
//                     setCurrentSearchPage(currentSearchPage - 1);
...
//                     Page{" "}
//                     <span className="text-blue-600 font-bold text-lg">{currentSearchPage}</span>{" "}
//                     of <span className="font-bold">{totalPages}</span>
//                   </span>
//                 </div>
